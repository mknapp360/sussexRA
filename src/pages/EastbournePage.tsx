...
export default function NearEastbourneMeetings() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <SEO
        title="Royal Arch Meetings near Eastbourne"
        description="View upcoming Royal Arch Chapter meetings near Eastbourne including Littlehampton, Pulborough, Eastbourne, and surrounding towns."
      />

      {/* Header Image Section - Similar to Home.tsx */}
      <section 
  className="relative h-[calc(100vh-4rem)] flex items-center justify-center mt-16"
  style={{
    backgroundImage: "url('/eastbourneTauFinal.png')",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">
            Upcoming Meetings near Eastbourne
          </h2>
