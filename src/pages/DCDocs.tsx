...
const dcDocuments: DocumentCard[] = [
  {
    id: 'ra-3',
    code: 'RA-3',
    title: 'RA Toast List',
  ...
  },
  {
    ...
    code: 'RA-19',
    title: 'DCs Handbook',
    description: 'Comprehensive handbook for Directors of Ceremonies with ceremony scripts and procedural guidance.',
    downloadUrl: 'https://yemckvysonazjfyvezli.supabase.co/storage/v1/object/public/docs/RA-19%20DC\'s%20Handbook%20Jul%202014%20ver%201.pdf',
  },
  {
    id: 'ra-43',
    code: 'RA-43',
    title: 'Provincial Grand Chapter Guidance',
    description: 'Official guidance on Red Table Meetings from the Provincial Grand Chapter.',
  ...
  },
  {
    id: 'ra-53',
    code: 'RA-53',
    title: 'Guidance for Exaltation of Multiple Candidates',
...
export default function DCDocs() {
  const jsonLd = [
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Director of Ceremonies Documents — Sussex Royal Arch",
      "url": "https://www.sussexroyalarch.co.uk/docs-forms/dc-docs",
      "description": "Essential documents and forms for Royal Arch Chapter Directors of Ceremonies in Sussex.",
    },
    {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "DC Documents", "item": "https://www.sussexroyalarch.co.uk/docs-forms/dc-docs" }
      ]
    }
  ];
  ...
  return (
    <>
      <SEO
        title="Director of Ceremonies Documents | Sussex Royal Arch"
        description="Essential documents, forms, and resources for Royal Arch Chapter Directors of Ceremonies in Sussex including ceremony scripts, toast lists, and procedural guidance."
        jsonLd={jsonLd}
      />
        ...
        <div className="container mx-auto max-w-4xl px-4">
          <div className="text-center">
            <div className="mb-4 mt-8">
              <span className="text-6xl" role="img" aria-label="Director of Ceremonies">
                📋
              </span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-headerText">
              Director of Ceremonies Documents
            </h1>
            <div className="h-1 w-32 bg-primary mx-auto mb-6"></div>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Essential documentation for Directors of Ceremonies including ceremony scripts, 
              processional guides, toast lists, and role responsibilities
            </p>
          </div>
        </div>
      </section>
