    ...
    <div className="min-h-screen bg-background">
                ...
                jsonLd={[
                  {
                    ...
                    "@type": "WebPage",
                    "name": "Archway Initiative - Sussex Royal Arch",
                    "url": "https://www.sussexroyalarch.co.uk/archway",
                    "description": "A system to help Royal Arch Chapters grow and enhance their membership experience",
                    "isPartOf": {
                      "@type": "WebSite",
      ...
      <section className="bg-[#f0f0f0] text-primary-foreground mt-12 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-black text-center text-4xl md:text-5xl font-bold mb-4">Archway</h1>
