...
export default function NearCrawleyMeetings() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <SEO
        title="Royal Arch Meetings near Crawley"
        description="View upcoming Royal Arch Chapter meetings near Crawley including Littlehampton, Pulborough, Crawley, and surrounding towns."
      />
      ...
      <section 
        ...
        style={{
          backgroundImage: "url('/CrawleyTauFinal.png')",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">
            Upcoming Meetings near Crawley
          </h2>
